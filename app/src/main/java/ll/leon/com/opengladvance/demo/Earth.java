...
//表示地球的类，采用多重纹理
public class Earth extends SimpleShaderUtils {
    ...
    public void initShader(View mv) {
        mProgram = createProgram(mv.getResources(), "vertex_earth.glsl", "frag_earth.glsl");
        //获取程序中顶点位置属性引用id
        ...
        //获取白天、黑夜两个纹理引用
        uDayTexHandle = getUniformId(mProgram, "sTextureDay");
        uNightTexHandle = getUniformId(mProgram, "sTextureNight");
        //获取位置、旋转变换矩阵引用id
