...
public abstract class BaseGLView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public int initTexture(int drawableId) {
        ...
        textureWidth = bitmapTmp.getWidth();
        textureHeight = bitmapTmp.getHeight();
        //实际加载纹理
        GLUtils.texImage2D
                (
