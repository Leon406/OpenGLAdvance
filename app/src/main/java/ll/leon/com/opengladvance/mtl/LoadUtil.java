...
import ll.leon.com.opengladvance.obj.ObjTexture;
...
public class LoadUtil {
    ...
    public static ObjTexture loadFromFile(String fname, Resources r, View mv) {
        //加载后物体的引用
        ObjTexture lo = null;
...
//                        break;
            ...
            //创建3D物体对象
            lo = new ObjTexture(mv, vXYZ, nXYZ, tST);
        } catch (Exception e) {
